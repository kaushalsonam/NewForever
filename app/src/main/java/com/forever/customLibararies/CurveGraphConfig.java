package com.forever.customLibararies;
...
public class CurveGraphConfig {
    ...
    private CurveGraphConfig(Builder builder) {
        ...
        yAxisScaleColor = (builder.yAxisScaleColor == 0) ? ContextCompat.getColor(builder.ctxWeakRef.get(), R.color.black) : builder.yAxisScaleColor;
        guidelineColor = (builder.guidelineColor == 0) ? ContextCompat.getColor(builder.ctxWeakRef.get(), R.color.fab_material_red_900) : builder.guidelineColor;
        axisColor = (builder.axisColor == 0) ? ContextCompat.getColor(builder.ctxWeakRef.get(), R.color.black) : builder.axisColor;
