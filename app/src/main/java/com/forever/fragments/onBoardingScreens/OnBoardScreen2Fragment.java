...
public class OnBoardScreen2Fragment extends Fragment implements View.OnClickListener, Observer<OnBoardingModel> {

    private TextView skip_btn,text1,dot1,dot2,dot3;
    private OnBoardingViewModel onBoardingViewModel;


    public static OnBoardScreen2Fragment newInstance() {
